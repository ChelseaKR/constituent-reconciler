...
`provider=aws.bedrock model=global.anthropic.claude-sonnet-4-6 prompt_version=assistant-prompts-2026-08-v1 commit=846418a5e393 date=2026-09-19 status=ran`
...
`provider=none (deterministic, no model call) model=n/a prompt_version=assistant-prompts-2026-08-v1 commit=846418a5e393 date=2026-09-19 status=deterministic`
